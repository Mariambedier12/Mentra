  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: "860px" }}>
        ...
        <div
          className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-10 max-w-[700px] mx-auto justify-items-center"
        >
          {features.map((feature, i) => (
            <div
              key={i}
              className="bg-[#ebeae8] rounded-[28px] p-6 w-full max-w-[210px] min-h-[180px] flex flex-col items-center justify-center gap-3 shadow-sm"
            >
              <div
                style={{
                  width: "3rem",
              ...
              <p style={{ margin: 0, fontSize: "16px", fontWeight: 700, color: "#111827", lineHeight: 1.3 }}>
                {feature.title}
              </p>
            </div>
          ))}
