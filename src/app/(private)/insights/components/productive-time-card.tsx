...
export default function ProductiveTimeCard({ start, end, label, tip }: Props) {
  return (
    <div style={{ background: "white", borderRadius: "16px", border: "1px solid #e5e7eb", padding: "1.5rem" }}>
      ...
      <div style={{ background: "#eff6ff", borderRadius: "10px", padding: "0.75rem 1rem", marginBottom: "1rem", display: "flex", alignItems: "center", gap: "10px" }}>
        ...
        <div>
          <p style={{ fontSize: "14px", fontWeight: 600, color: "#1e3a8a" }}>{start} – {end}</p>
      ...
      <p style={{ fontSize: "12px", color: "#6b7280", lineHeight: 1.6, marginTop: "0.75rem", fontStyle: "italic" }}>
        Tip: {tip}
      </p>
    </div>
  );
